...
router.post('/register', [(0, express_validator_1.check)("firstName", "First Name is Required").isString(),
    (0, express_validator_1.check)("lastName", "Last Name is Required").isString(),
    (0, express_validator_1.check)("email", "Please enter a  email id").isEmail(),
