...
const SearchResultCard = ({hotel}:Props) => {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[2fr_3fr] border border-slate-300 rounded-lg p-8 gap-4">
...
<div className="grid grid-rows-[1fr_2fr_1fr]">
    ...
    <div >
        ...
        <div className="flex items-center">
            ...
            <span className="m-1 text-sm">{hotel.type}</span>
        </div> 
    ...
    <div className="grid grid-cols-2 items-end whitespace-nowrap">
        ...
        <div className="flex flex-col items-end gap-1">
            ...
            <Link to={`/details/${hotel._id}`} className="bg-blue-600 text-white h-full p-3 font-bold text-xl max-w-fit hover:bg-blue-500">View More</Link>
        </div>
    </div>
