...
const BookingForm = ({ currentUser , paymentIntent}: Props) => {
   ...
   showToast({message:"Booking Saved",type:"SUCCESS"})
        ...
        onError:()=>{
showToast({message:"Error Booking" ,type:"ERROR"})
        },
    })
    ...
    // Optional: If you want to handle form submission
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-5 rounded-lg border border-slate-300 p-5">
            ...
            <div className="flex justify-end">
                <button type="submit" disabled={isLoading} className="bg-blue-600 text-white p-2 font-bold hover:bg-blue-400 text-md disabled:bg-gray-400">{isLoading ? "Saving" :"Confirm Booking"}</button>
            </div>
